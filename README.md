...
1. **Executive Summary:** High-level KPIs including total sales, total journeys, and overall delay rates.

2. **Routes Analysis:** Popularity ranking and geographic analysis via interactive maps.

3. **Ticket Analysis:** Revenue breakdown by ticket type (e.g., Advance, Off-Peak) and class.

4. **Customer Behavior:** Analysis of purchase channels and lead times.

5. **Delays & Refunds:** Deep dive into the main causes of delays and their associated compensation costs.
